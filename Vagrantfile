...
Vagrant.configure("2") do |config|
  ...
  # machine will have an IP address of 192.168.123.10 and a virtual network adapter will be
  # created on your host machine with the IP of 192.168.123.1 as a gateway.
  #
  ...
  #
  # Note: If your existing network is using the 192.168.123.x subnet, this default IP address
