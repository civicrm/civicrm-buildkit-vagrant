...
echo "- CiviCRM docs & guides at https://docs.civicrm.org"
echo "- Developer guide: https://docs.civicrm.org/dev/en/latest/"
echo "- This set of tools: https://docs.civicrm.org/dev/en/latest/tools/buildkit/"
echo "- CiviCRM Chat: https://chat.civicrm.org/"
echo "- CiviCRM Q&A: https://civicrm.stackexchange.com/"
